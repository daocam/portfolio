...
export default function Education() {
  const education = [
    {
      degree: "AEC - Conception et programmation de sites web",
      institution: "Collège de Maisonneuve",
      period: "2021 – 2023",
      achievements: [
        "Stage de fin d’études en tant que Développeur Web",
        "Projet de fin d’études réalisé sur une « Application de vente de véhicule d'occasion »",
      ],
    },
  ];
