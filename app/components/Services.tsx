  ...
  const services = [
    {
      ...
      description:
        "Applications web personnalisées construites avec React et Next.js, axées sur la performance et l’expérience utilisateur.",
    },
    {
      icon: <Server className="w-12 h-12 text-green-500" />,
      title: "Développement backend",
      description:
        "Solutions côté serveur robustes et évolutives utilisant Node.js et Express.",
    },
    {
      icon: <Code className="w-12 h-12 text-purple-500" />,
      title: "Développement d'API",
      description:
        "Conception et implémentation d’API RESTful pour un flux de données fluide entre le client et le serveur.",
    },
    {
      icon: <Smartphone className="w-12 h-12 text-yellow-500" />,
      title: "Responsive Design",
      description:
        "Designs web responsives et mobiles-first qui fonctionnent parfaitement sur tous les appareils et tailles d’écran.",
    },
  ];
